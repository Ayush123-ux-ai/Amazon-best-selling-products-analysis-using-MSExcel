...
# 🛒 Amazon Best-Selling Products Analysis (Excel Dashboard)
...
Using Microsoft Excel, this project demonstrates how business intelligence techniques can uncover insights useful for e-commerce businesses, product managers, and data analysts.
...
- Build an interactive dashboard for dynamic insights  
...
- **StoreLocation** – Physical or online store location of the sale  
- **CustomerType** – Type of customer (e.g., Regular, New, Premium)  
- **Discount** – Discount applied to the product (if any)  
- **Salesperson** – Name or ID of the salesperson handling the sale  
- **PaymentMethod** – Mode of payment (e.g., Credit Card, Cash, UPI)  
...
- **Sales** – Total sales value (Quantity × Unit Price − Discount + adjustments)   
...
- Regional analysis reveals variation in product demand  
- High-performing products can be targeted for marketing and inventory optimization  
